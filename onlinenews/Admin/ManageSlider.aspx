<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.Master" AutoEventWireup="true" CodeBehind="ManageSlider.aspx.cs" Inherits="onlinenews.Admin.ManageSlider" %>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-striped">
                    <asp:Repeater ID="RepeaterNewsSlider" runat="server">
