<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SliderNewsExpose.aspx.cs" Inherits="onlinenews.SliderNewsExpose" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="articles">
      ...
      <div class="single">
        ...
        <p><img class="alignright" src="themes/images/200x150.gif" width="200" height="150" alt="" /></p>
